...
namespace OVOVAX.Repository.Migrations
{
    ...
    [Migration("20250620194130_AddUserIdToEntitiesWithDataHandling")]
    partial class AddUserIdToEntitiesWithDataHandling
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OVOVAX.Core.Entities.Identity.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("OVOVAX.Core.Entities.Identity.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("OVOVAX.Core.Entities.Injection.InjectionOperation", b =>
                {
                    b.HasOne("OVOVAX.Core.Entities.Identity.AppUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
